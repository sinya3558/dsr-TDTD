...
project_folder = "TRAINED_OUTPUT"
model_filename = "yolo26n.pt"
data_yaml_filename = "data.yaml"
##
dataset_filename = "Plastic_Bottle_Image_Dataset"

# 자동으로 현재 폴더 기준 경로 설정
BASE_DIR = os.getcwd()  # 현재 폴더 기준
OUTPUT_DIR = os.path.join(BASE_DIR, project_folder)  # 원하는 상위 폴더 이름
##
DATASET_DIR = os.path.join(BASE_DIR, dataset_filename)
...
data_yaml_path = os.path.join(DATASET_DIR, data_yaml_filename)
